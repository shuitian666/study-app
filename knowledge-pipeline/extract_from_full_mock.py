# -*- coding: utf-8 -*-
"""
从完整的 mock.ts 提取各学科JSON
从 E:\test001\TRAE_project\src\data\mock.ts 读取
"""
...
def extract_array(content: str, start_marker: str, end_marker: str = None):
    """从内容中提取数组"""
...
def main():
    print("=" * 60)
    print("从完整 mock.ts 提取知识库数据")
    print("=" * 60)

    # 从test001目录读取完整mock.ts
    mock_path = Path(r"E:\test001\TRAE_project\src\data\mock.ts")

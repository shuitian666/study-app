...
export const MOCK_SUBJECTS: Subject[] = [
  ...
  { id: 'chem', name: '化学', icon: '🧪', color: '#3b82f6', knowledgePointCount: 25 },
  ...
  { id: 'immuno', name: '免疫学', icon: '🔬', color: '#8b5cf6', knowledgePointCount: 12 },
...
export const MOCK_CHAPTERS: Chapter[] = [
  ...
  // 免疫学
  { id: 'immunology-ch1', subjectId: 'immuno', name: '免疫学基础', order: 1 },
  // 微生物与免疫学
